...
public class MyStorage {
    ...
    public static int selectMenu(Scanner s){
        ...
        return Integer.parseInt(s.nextLine());  // 입력 받은 정수를 반환합니다.
    }
    ...
    static void prod_input(Scanner s){
        ...
        if (!addProduct) {
            ...
            System.out.println("[System] 제품 등록 공간이 다 찼습니다. 더이상 추가 할 수 없습니다.");
            System.out.println("-".repeat(30));
        } else System.out.println("[System] 등록이 완료되었습니다.");
    ...
    static void prod_remove(Scanner s){
        ...
        for (int i = 0; i < products.length; i++) {
            if (removeProduct.equals(products[i])) {
                products[i] = EMPTY;
                remove = true;
                break;
            }
        ...
        if (!remove) {
            System.out.println("-".repeat(30));
            System.out.println("[System] 그런 물품은 존재하지 않습니다.");
            System.out.println("-".repeat(30));
        } else System.out.println("[System] 제품 취소가 완료되었습니다.");
    ...
    public static void prod_amount_add(Scanner s) {
        ...
        if (foundIdx < 0){  // 제품을 찾지 못한 경우
            ...
            return; // 메서드를 호출한 곳으로 반환 main에서 불렀으면 main으로 돌아감
        }
        ...
        try {
            ...
            System.out.println("[Warning] 수량이 아닌 다른 걸 입력하셨습니다.");
        }
    }
    ...
    public static void prod_amount_decrease(Scanner s) {
        ...
        if (removeIndex == -1) {
            System.out.println("[Warning] 입력한 제품명이 없습니다. 다시 확인해주세요.");
            return;
        }
        ...
        try {
            ...
            if (productCount < 0 || productCount > counts[removeIndex]) {
                System.out.println("[Warning] 남은 수량보다 더 많이 출고할 수 없습니다");
                return;
            }
            counts[removeIndex] -= productCount;
            System.out.println("[Clear] 출고가 완료되었습니다.");
        } catch (InputMismatchException e) {
            System.out.println("[Warning] 수량을 입력하여 주시길 바랍니다.");
        }
    ...
    public static void main(String[] args){
        ...
        System.out.print("[System] 점장님 어서오세요.\n[System] 해당 프로그램의 기능입니다.\n");
